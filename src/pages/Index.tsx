...
const Index = () => {
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse at bottom, hsl(230 30% 12%) 0%, hsl(230 35% 5%) 100%)",
      }}
    >
      ...
      <main className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-12">
        ...
        <h1 className="text-center">
          ...
          <h1 className="block text-4xl md:text-6xl lg:text-8xl font-display font-bold gold-text text-glow lg:leading-loose">
            Tết Nguyên Đán
          </h1>
          <span className="block text-5xl md:text-7xl lg:text-9xl font-display font-bold text-primary">
            2026
          </span>
        </h1>
