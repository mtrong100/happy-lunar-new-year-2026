  ...
  return (
    <div className="flex flex-wrap justify-center gap-4 md:gap-6 lg:gap-8">
      {timeUnits.map((unit, index) => (
        <div
          key={unit.label}
          className="countdown-card flex flex-col items-center min-w-[80px] md:min-w-[120px] lg:min-w-[140px] animate-float"
          style={{ animationDelay: `${index * 0.2}s` }}
        >
          <span className="countdown-number text-4xl md:text-6xl lg:text-7xl font-display font-bold gold-text">
